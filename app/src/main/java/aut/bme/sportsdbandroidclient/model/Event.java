...
public class Event {
    ...
    public Integer getIdSoccerXML() {
        return idSoccerXML;
    }

    public void setIdSoccerXML(Integer idSoccerXML) {
    ...
    public Date getDateEventLocal() {
        return dateEventLocal;
    }

    public void setDateEventLocal(Date dateEventLocal) {
